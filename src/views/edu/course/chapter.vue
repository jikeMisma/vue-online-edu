      ...
      <el-form :model="video" label-width="120px">
        ...
        <el-form-item label="上传视频">
          <el-upload
            ...
            :file-list="fileList"
            :action="BASE_API + '/enuvod/video/uploadAliyunVideo'"
            :limit="1"
            class="upload-demo"
          >
...
export default {
  ...
  methods: {
    ...
    handleVodRemove() {
      //调用接口的删除视频方法
      videoApi.deleteAliyunVideo(this.video.videoSourceId).then(response => {
        //提示信息
        this.$message({
          type: "success",
          message: "删除视频成功!"
